  ...
  render() {
    ...
    if (params.id === "new") {
      element = <Form>
        ...
        <Form.Group as={Row} >
          <Col sm="1">
            <Button variant="outline-success" onClick={this.addUser}>{isAdd ? <img src={LoadingButton} alt={'Adding...'} style={{ height: "35px" }} /> : 'Submit'}</Button>
          </Col>
          <Col sm="1">
      ...
      element = show && <Form>
        ...
        <Form.Group as={Row} >
          <Col sm="1">
            <Button variant="outline-success" onClick={this.updateUser}>{isEdit ? <img src={LoadingButton} alt={'Gif'} style={{ height: "35px" }} /> : 'Edit'}</Button>
          </Col>
          <Col sm="1">
